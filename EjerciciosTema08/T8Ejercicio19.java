public class T8Ejercicio19 {
  ...
  public static void main (String[] args) {
    ...
    switch (opcion) {
      ...
      case 4:
        ...
        break;
      case  5:
        resultado = Long.toString(binarioADecimal(octalABinario
	  (numeroIntroducido)));
        break;
      case  6:
      ...
      case  7:
        ...
        break;
      case  8:
        resultado = Long.toString(binarioAOctal(decimalABinario
	  (numeroIntroducido)));
        break;
      case  9:
      ...
      case 10:
        ...
        break;
      case 11:
        resultado = Long.toString(binarioAOctal(hexadecimalABinario
	  (numeroIntroducidoString)));
        break;
      case 12:
        resultado = Long.toString(binarioADecimal(hexadecimalABinario
	  (numeroIntroducidoString)));
        break;
    }
  ...
  public static String binarioAHexadecimal(long binario) {
    ...
    while (binario > 0) {
      hexadecimal = digitosHexa.charAt((int)binarioADecimal(binario % 10000))
	+ hexadecimal;
      binario /= 10000;
    }
  ...
  public static long octalABinario(long octal) {
    ...
    for (int i = 0; i < matematicas.Varias.digitos(octal); i++) {
      binario *= 1000;
      binario += decimalABinario(matematicas.Varias.digitoN(octal, i));
    }
  ...
  public static long hexadecimalABinario(String hexadecimal) {
    ...
    for (int i = 0; i < hexadecimal.length(); i++) {
      binario = binario * 10000 + decimalABinario(digitosHexa.indexOf
